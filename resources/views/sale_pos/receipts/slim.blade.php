...
<html lang="en">
    ...
    <body>
        <div class="ticket">
        	...
        	@endif
        	<div class="text-box">
        		<img style="max-height: 120px; width: auto;" src="https://nibizsoft.xyz/zarhan/uploads/invoice_logos/transparent-logo.png" class="img img-responsive center-block">
        	<!-- Logo -->
            <p class="centered">
				...
				@if(!empty($receipt_details->display_name))
					<span class="headings" style="font-size: 20px !important">
				...
				<span  style="font-size: 16px !important; font-weight: 600;">
			...
			<div class="border-top textbox-info">
				<p class="f-left">{!! $receipt_details->invoice_no_prefix !!}</p>
				<p class="f-right">
					{{$receipt_details->invoice_no}}
				</p>
			</div>
			<div class="textbox-info">
				<p class="f-left">{!! $receipt_details->date_label !!}</p>
				<p class="f-right">
			...
			@if(!empty($receipt_details->due_date_label))
				<div class="textbox-info">
					<p class="f-left">{{$receipt_details->due_date_label}}</p>
			...
			@if(empty($receipt_details->hide_price))
				...
				<p colspan="2" class="text-right mb-0 sub-headings">
					<small>
				...
				@if(!empty($receipt_details->payments))
					@foreach($receipt_details->payments as $payment)
						<div class="flex-box">
							<p class="width-50 text-right sub-headings">{{$payment['method']}} ({{$payment['date']}}) </p>
            ...
            <p class="centered"><span style="font-weight: 600; font-size: 14px;">Hotline</span> : +8801988869888</p>
				
            <p class="centered">"Products can be exchanged in<br> 7 days.  Products must be brought<br> in new condtion"</p>
        ...
        <p class="centered sub-headings"><b>Powered By N I Biz Soft</b></p>
